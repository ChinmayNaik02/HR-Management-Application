...
<body>
    <div class="container">
        ...
        <?php
            $yearParam = isset($_POST['year']) ? $_POST['year'] : null;
            $employeeName = isset($_POST['employeeName']) ? $_POST['employeeName'] : null;
            ...
            try {
                ...
                if ($employeeName) {
                    ...
                    $stmt->execute([$employeeName, $yearParam]);
                } else {
            ...
            $overtimeHours = $totalWorkingHours - (8 * 260);
            if ($overtimeHours < 0) {
                $overtimeHours = 0;
            }
        ?>
        ...
        <?php if ($employeeName): ?>
            <div class="attendance-item">
                ...
                <div class="value"><?php echo htmlspecialchars($employeeName); ?></div>
            </div>
        <?php endif; ?>
        <div class="attendance-item">
            <div class="attribute">Year:</div>
            <div class="value"><?php echo htmlspecialchars($yearParam); ?></div>
        </div>
